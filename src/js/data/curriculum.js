...
window.CURRICULUM = [
  {
    ...
    ues: [
      ...
      { code: 'UE3', title: 'Réfraction', h: 70, cm: 30, td: 40, tp: 0, ects: 4,
        links: { formulas: ['skiascopie', 'transposition', 'equivalent', 'addition', 'vertex'], mod: ['reading'], calc: ['transpose', 'accom', 'vertex'], chap: ['refraction'], cats: ['Réfraction', 'Optique'] } },
      { code: 'UE4', title: 'Physiologie du système visuel, physiologie neurosensorielle', h: 50, cm: 40, td: 10, tp: 0, ects: 3,
        links: { mod: ['reading'], chap: ['anatomie'], cats: ['Anatomie'] } },
      { code: 'UE5', title: 'Vision monoculaire, acuités visuelles et anomalies', h: 50, cm: 25, td: 25, tp: 0, ects: 3,
        links: { formulas: ['logmar', 'mar', 'optotype'], mod: ['reading'], calc: ['acuity'], chap: ['refraction'], cats: ['Mesures'] } },
      ...
      { code: 'UE8', title: 'Physiologie de l’appareil oculomoteur et vision binoculaire', h: 50, cm: 40, td: 10, tp: 0, ects: 3,
        links: { formulas: ['convergence', 'aca_gradient', 'stereo'], mod: ['reading'], chap: ['oculomotricite', 'binoculaire'], cats: ['Oculomotricité', 'Vision binoculaire'] } },
      { code: 'UE9', title: 'Physiopathologie de l’oculomotricité et de la vision binoculaire', h: 60, cm: 40, td: 20, tp: 0, ects: 4,
        links: { formulas: ['hirschberg', 'krimsky', 'aca_gradient', 'aca_hetero'], mod: ['reading'], chap: ['strabismes', 'binoculaire'], cats: ['Strabologie', 'Vision binoculaire'] } },
      ...
      { code: 'UE16', title: 'Pathologies ophtalmologiques et générales', h: 40, cm: 30, td: 10, tp: 0, ects: 2,
        links: { mod: ['reading'], chap: ['pathologies'], cats: ['Pathologies'] } }
    ],
...

  {
    ...
    ues: [
      ...
      { code: 'UE10', title: 'Explorations fonctionnelles', h: 63, cm: 25, td: 38, tp: 0, ects: 4,
        links: { formulas: ['logmar'], mod: ['reading'], chap: ['pathologies'], cats: ['Explorations', 'Pathologies', 'Mesures'] } },
...

  {
    ...
    ues: [
      { code: 'UE24', title: 'Amblyopie fonctionnelle, privation visuelle', h: 45, cm: 30, td: 15, tp: 0, ects: 3,
        links: { formulas: ['logmar'], mod: ['reading'], chap: ['strabismes'], cats: ['Amblyopie', 'Strabologie'] } },
...

  {
    ...
    ues: [
      ...
      { code: 'UE23', title: 'Prise en charge orthoptique des pathologies neuro-ophtalmologiques', h: 90, cm: 30, td: 60, tp: 0, ects: 7,
        links: { mod: ['rehab', 'reading', 'patient'], chap: ['oculomotricite'], cats: ['Neuro-ophtalmologie', 'Rééducation', 'Oculomotricité'] } },
      { code: 'UE27', title: 'Bilan et prise en charge orthoptique de la basse vision', h: 90, cm: 30, td: 60, tp: 0, ects: 7,
        links: { formulas: ['kestenbaum'], mod: ['reading'], calc: ['vertex', 'acuity'], chap: ['pathologies'], cats: ['Basse vision', 'Pathologies'] } },
...

  {
    ...
    ues: [
      ...
      { code: 'UE29', title: 'Vision et troubles de l’apprentissage', h: 60, cm: 30, td: 30, tp: 0, ects: 5,
        links: { mod: ['rehab', 'reading'], chap: ['binoculaire'], cats: ['Rééducation', 'Vision binoculaire'] } },
      { code: 'UE30', title: 'Troubles neurovisuels, vision et équilibre', h: 80, cm: 20, td: 60, tp: 0, ects: 6,
        links: { mod: ['rehab', 'reading'], chap: ['oculomotricite'], cats: ['Neuro-ophtalmologie', 'Oculomotricité'] } },
