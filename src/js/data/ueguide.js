...
UE02: {
  ...
  plan: [
    { t: '1 · Les lois de Descartes et la réflexion totale',
      p: 'La lumière est une onde électromagnétique dont le visible ne couvre que 400 à 800 nm ; sa célérité dans le vide vaut 3·10⁸ m/s, et l’indice d’un milieu n’est que le rapport de cette célérité à celle qu’elle y prend. À la traversée d’un dioptre : le rayon réfléchi repart symétriquement (i′ = i₁), et le réfracté obéit à <b>n₁ sin i₁ = n₂ sin i₂</b>. Vers un milieu plus réfringent le rayon se rapproche de la normale ; vers un milieu moins réfringent il s’en éloigne, jusqu’à un angle limite λ tel que <b>sin λ = n₂/n₁</b> au-delà duquel plus rien ne passe : c’est la <b>réflexion totale</b>, celle des fibres optiques.' },
    { t: '2 · Le prisme : les formules exactes',
      p: 'Quatre relations suffisent : sin i = n sin r, n sin r′ = sin i′, <b>A = r + r′</b> et <b>D = i + i′ − A</b>. Au minimum de déviation, le trajet devient symétrique (r = r′ = A/2) et l’on accède à l’indice par sin((Dm+A)/2) = n sin(A/2). Pour qu’un rayon sorte, il faut r′ < λ, donc <b>A < 2λ</b> : un prisme de plexi d’angle droit ne laisse rien passer, il réfléchit totalement. Aux petits angles — le régime de l’orthoptie — tout se réduit à <b>D = (n−1)A</b>.' },
    { t: '3 · Vergence et dioptrie',
    ...
    { t: '4 · Le dioptre sphérique',
      p: 'Une surface sphérique de rayon SC séparant deux indices n et n′ : <b>n′/SA′ − n/SA = (n′−n)/SC</b>, dans les conditions de Gauss (rayons proches de l’axe et peu inclinés). Les foyers valent f′ = SF′ = n′·SC/(n′−n) et f = SF = −n·SC/(n′−n) ; on vérifie toujours que <b>f + f′ = SC</b> et que f/f′ = −n/n′. La vergence V = n′/f′ s’exprime en dioptries. Il faut un saut d’indice ET une courbure pour dévier : une lentille plongée dans un liquide de même indice devient invisible.' },
    { t: '5 · Dioptres et lentilles minces',
    ...
    { t: '6 · Les miroirs sphériques',
      p: 'Concave si la face interne réfléchit — le centre C est alors dans l’espace réel — convexe sinon. Dans les conditions de Gauss le foyer est au milieu du rayon : <b>SF = SC/2</b>. Trois rayons construisent l’image : celui qui passe par C n’est pas dévié, celui qui arrive parallèle repart par F, celui qui passe par F repart parallèle. Conjugaison avec origine au sommet : <b>2/SC = 1/SA + 1/SA′</b> ; au centre : 2/CS = 1/CA + 1/CA′ ; au foyer (Newton) : FA·FA′ = f². Un miroir concave avec l’objet en deçà du foyer donne une image virtuelle, droite et agrandie — c’est le miroir de dentiste.' },
    { t: '7 · L’œil comme système optique',
    ...
    { t: '10 · Loi de Prentice et décentrement',
    ...
    { t: '11 · Distance de sommet, aberrations, diffraction',
